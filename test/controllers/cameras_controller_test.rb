...
class CamerasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create camera" do
    assert_difference("Camera.count") do
      post cameras_url, params: { camera: { image: @camera.image, name: @camera.name, price: @camera.price, type: @camera.type } }, as: :json
    end
  ...
  test "should update camera" do
    patch camera_url(@camera), params: { camera: { image: @camera.image, name: @camera.name, price: @camera.price, type: @camera.type } }, as: :json
    assert_response :success
  end
